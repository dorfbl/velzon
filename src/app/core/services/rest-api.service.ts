...
export class restApiService {
  ...
  */
  // Get
  getCustomerData(orderByField: string = 'id', queryParam: string = '', sortOrder: 'ASC' | 'DESC' = 'ASC'): Observable<any> {
    var headerToken = { 'Authorization': `Bearer ` + sessionStorage.getItem('token') };
    return this.http.get(GlobalComponent.API_URL + GlobalComponent.customer + '?' + queryParam + '&orderBy=' + orderByField + '&sortOrder=' + sortOrder, { headers: headerToken, responseType: 'text' });
  }
